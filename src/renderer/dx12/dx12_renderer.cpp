...
void cg::renderer::dx12_renderer::load_assets()
{
	...
	for(size_t i = 0; i<shape_num; i++)
	{
		...
		create_resource_on_upload_heap(upload_vertex_buffers[i], vertex_buffer_size, vertex_buffer_name);
		...
		create_resource_on_upload_heap(upload_index_buffers[i], index_buffer_size, index_buffer_name);
